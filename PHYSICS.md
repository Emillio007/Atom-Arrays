...
$$\mathbf{\bar{E}}_{out}(\bar{r}) = \mathbf{\bar{E}}_{in}(\bar{r}) + \mu_0 \omega_0^2 \sum_j \mathbf{G}(\bar{r}, \bar{r}_j, \omega_0) \bar{D}_j \mathbf{\sigma}_-^j$$.
...
$$\mathbf{H}_{eff} = \sum_i -\mathbf{\bar{p}}_i \mathbf{\bar{E}}_{out}(\bar{r}_i) = - \mu_0 \omega_0^2 \sum_{i,j} \bar{D}_i^\dagger \mathbf{G}(\bar{r}_i, \bar{r}_j, \omega_0) \bar{D}_j \mathbf{\sigma}_+^i \mathbf{\sigma}_-^j$$.
